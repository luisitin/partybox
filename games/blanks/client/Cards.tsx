...
export function CardFan({ label, leaving }: { label?: string; leaving?: boolean } = {}): JSX.Element {
  // I-013 B: with a label the black card turns over to show it (the round, printed on the card).
  // I-013 C: `leaving` slides the whole fan up and away.
  return (
    <div className={`${styles.fan} ${leaving ? styles.fanLeave : ''}`} aria-hidden>
