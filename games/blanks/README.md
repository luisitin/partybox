...
Three decks, `mild.json` (clean, 521 black / 1451 white), `crude.json` (adult, 359 / 1059) and `wild.json`
(explicit, 399 / 1455) — 5 244 cards, about one black card in ten a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
