...
Three decks, `mild.json` (clean, 628 black / 1624 white), `crude.json` (adult, 445 / 1202) and `wild.json`
(explicit, 463 / 1603) — 5 965 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
