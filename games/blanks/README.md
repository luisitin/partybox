...
Three decks, `mild.json` (clean, 603 black / 1589 white), `crude.json` (adult, 426 / 1173) and `wild.json`
(explicit, 451 / 1573) — 5 815 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
