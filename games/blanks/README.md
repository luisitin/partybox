...
Three decks, `mild.json` (clean, 976 black / 2172 white), `crude.json` (adult, 726 / 1673) and `wild.json`
(explicit 717 / 2140) — 8 404 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
