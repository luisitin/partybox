...
Three decks, `mild.json` (clean, 1101 black / 2353 white), `crude.json` (adult, 852 / 1846) and `wild.json`
(explicit 803 / 2286) — 9 241 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
