...
Three decks, `mild.json` (clean, 324 black / 1119 white), `crude.json` (adult, 222 / 835) and `wild.json`
(explicit, 276 / 1224): `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
