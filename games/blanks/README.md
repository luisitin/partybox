...
Three decks, `mild.json` (clean, 1124 black / 2389 white), `crude.json` (adult, 872 / 1872) and `wild.json`
(explicit 821 / 2310) — 9 388 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
