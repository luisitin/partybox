...
Three decks, `mild.json` (clean, 656 black / 1667 white), `crude.json` (adult, 470 / 1242) and `wild.json`
(explicit, 481 / 1631) — 6 147 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
