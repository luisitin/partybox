...
Three decks, `mild.json` (clean, 472 black / 1344 white), `crude.json` (adult, 329 / 995) and `wild.json`
(explicit, 379 / 1395) — 4 914 cards, about one black card in twelve a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
