...
Three decks, `mild.json` (clean, 857 black / 1967 white), `crude.json` (adult, 642 / 1509) and `wild.json`
(explicit, 617 / 1847) — 7 439 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
