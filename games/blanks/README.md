...
| `reveal` | one filled card, big; the ones already read, small; the reader named in czar mode; a quiet bar                                                           | the same card                                               | 2.2 s + 18 ms/char ≤ 4 s (past 8 cards: 2 s + 14 ms/char ≤ 3.2 s) → next `reveal` or `judge`; VIP skip → `judge`                                                                                                                                                |
