...
Three decks, `mild.json` (clean, 521 black / 1451 white), `crude.json` (adult, 329 / 1059) and `wild.json`
(explicit, 379 / 1455) — 5 194 cards, about one black card in ten a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
