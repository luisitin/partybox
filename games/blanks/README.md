...
Three decks, `mild.json` (clean, 324 black / 1119 white), `crude.json` (adult, 172 / 835) and `wild.json`
(explicit, 237 / 1224): `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
