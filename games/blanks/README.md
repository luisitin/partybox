...
Three decks, `mild.json` (clean, 744 black / 1796 white), `crude.json` (adult, 545 / 1359) and `wild.json`
(explicit, 539 / 1722) — 6 705 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
