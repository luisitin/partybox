...
Three decks, `mild.json` (clean, 443 black / 1281 white), `crude.json` (adult, 309 / 965) and `wild.json`
(explicit, 361 / 1355) — 4 714 cards, about one black card in ten a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
