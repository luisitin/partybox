...
Three decks, `mild.json` (clean, 1001 black / 2212 white), `crude.json` (adult, 767 / 1726) and `wild.json`
(explicit 734 / 2166) — 8 606 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
