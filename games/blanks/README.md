...
Three decks, `mild.json` (clean, 714 black / 1752 white), `crude.json` (adult, 519 / 1321) and `wild.json`
(explicit, 520 / 1692) — 6 518 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
