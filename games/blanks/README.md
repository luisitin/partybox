...
Three decks, `mild.json` (clean, 406 black / 1281 white), `crude.json` (adult, 281 / 965) and `wild.json`
(explicit, 335 / 1355) — 4 623 cards: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
