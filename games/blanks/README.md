...
Three decks, `mild.json` (clean, 1214 black / 2517 white), `crude.json` (adult, 946 / 1972) and `wild.json`
(explicit 889 / 2407) — 9 945 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
