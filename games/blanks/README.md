...
Three decks, `mild.json` (clean, 191 black / 587 white), `crude.json` (adult, 172 / 461) and `wild.json`
(explicit, 237 / 797): `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
