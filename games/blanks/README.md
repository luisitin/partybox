...
Three decks, `mild.json` (clean, 362 black / 1237 white), `crude.json` (adult, 251 / 937) and `wild.json`
(explicit, 306 / 1329) — 4 422 cards: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
