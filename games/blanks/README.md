...
Three decks, `mild.json` (clean, 685 black / 1711 white), `crude.json` (adult, 496 / 1282) and `wild.json`
(explicit, 500 / 1657) — 6 331 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
