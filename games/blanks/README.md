...
Three decks, `mild.json` (clean, 884 black / 2007 white), `crude.json` (adult, 661 / 1579) and `wild.json`
(explicit, 666 / 1977) — 7 774 cards, about one black card in nine a Pick 2 or Pick 3: `{ id, name, rating, black: [{ id, text, pick, draw }], white: [{ id, text }] }`,
