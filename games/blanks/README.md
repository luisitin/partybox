...
| `reveal` | one filled card, big; the ones already read, small; a quiet bar                                                        | the same card                                               | 3.5 s + 35 ms/char ≤ 8 s (past 8 cards: 3 s + 25 ms/char ≤ 5.5 s) → next `reveal` or `judge`; VIP skip → `judge`                                                                                                                                                |
