// Phase "intro": the round card ("Round r of R", the judge's name in czar mode). Entering it
// starts the round: discards, refills, draws the black card. Exits on the 5 s deadline or VIP skip.
