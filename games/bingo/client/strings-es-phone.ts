...
export const ES_PHONE: Readonly<Record<string, string>> = {
  ...
  'picked — waiting for {n} more': 'elegido: esperando a {n} más',
  'picked — waiting for {a} and {b}': 'elegido: esperando a {a} y {b}',
  'picked — waiting for {name}': 'elegido: esperando a {name}',
  'everyone is waiting for you': 'todos te esperan',
  'swap a card, or play these': 'cambia un cartón o juega estos',
  'swap it, or play it': 'cámbialo o juégalo',
  Another: 'Otro',
  Picked: 'Elegido',
  Swapped: 'Cambiado',
  'card {n}': 'cartón {n}',
