...
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `intro`      | Deals the round: fresh deck (1–75 shuffled), `cards` fresh cards per player. TV: round number + pattern demo, the deal (card backs fanning on the phones' beats) and "first number in 3 · 2 · 1" with ticks. Phones: pattern + the new cards dealt in, the same 3 · 2 · 1 as taps, and one "deal me another" per card (`swap`, the new card flips in). The card-style sheet also holds a per-device motion switch (off: cards switch without the rise).                                                                                                                                                                                                                                                                                   | deadline · VIP skip → `play`                                                                                                                                                                             | 5 s                                                                          |
