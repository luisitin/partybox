...
- Regenerate fixtures after changing state shape: pnpm sim --game herd-mind --dump-fixtures --players 4
- Test: pnpm vitest --project games · pnpm vitest --project contract · pnpm sim --game herd-mind --players 6 --runs 200
