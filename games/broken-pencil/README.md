...
| `summary` | "k of N books survived" + every book's word → last guess — the rows rise 80 ms apart and each ✓ / ✕ stamps down after its row (I-022 A).                                                                                                                                                                                                                                                                                                                                                                              | deadline · VIP skip → `done`                                                                               | 15 s                                                                     |
