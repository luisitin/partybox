...
- Regenerate fixtures after changing state shape: pnpm sim --game hive-rank --dump-fixtures --players 4
- Test: pnpm vitest --project games · pnpm vitest --project contract · pnpm sim --game hive-rank --players 6 --runs 200
