// Phase "intro" (once): the title and the three steps. Ends after INTRO_MS or on the VIP's
// "Let's go" (a skip). The first question's reading is asked for here, so it is ready at `rank`.
