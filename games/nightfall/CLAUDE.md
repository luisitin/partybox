...
- Regenerate fixtures after changing state shape: pnpm sim --game nightfall --dump-fixtures --players 4
- Test: pnpm vitest --project games · pnpm vitest --project contract · pnpm sim --game nightfall --players 6 --runs 200
