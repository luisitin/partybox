...
| `reveal`   | correct choice marked ✓, per player: ✓/✗/–, points, 🔥 streak (a "phone only" room gets the same `rows` on the phone)                                                                                                                                                                                                                                                                              | same grid with ✓/✗ marks + outcome line           | 5 s deadline or VIP skip → next `question`; after the last regular one `wager`; after the final `done`                           |
