...
| `question` | question + choices A–D in a 2×2 grid, "n / m answered" — every locked-in face pops onto the count line (I-007 A) and the phones still thinking are ringed in the strip until they lock in (B)                                                                                                                                                                                                                                                                                                                                                                                                                                                | `ChoiceGrid`, one tap locks the pick; I-288 B: "+974 now" under the question (`worth`), draining with the speed bonus until the tap | every connected player picked, or `answerSeconds` deadline, or VIP skip → `reveal`                                               |
