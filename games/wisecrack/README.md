...
| `answer` | "n / 2·connected answers in"; no answers shown           | `TextAnswer` for prompt 1 of 2, then 2 of 2 (80 chars)  | all connected players answered both, `answerSeconds`, or VIP skip → first votable `vote` |
