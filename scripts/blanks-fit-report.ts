...
if (values.md) {
  ...
  const lines: string[] = [
    ...
    '- **Hands.** Ten cards, always: 2 things, 3 doings, 2 people, 2 names; 5 great cards, 2 of them amazing; at most 2 filler; no four cards on one subject (`server/deal.ts`). Once the prompt is known, the hand leads with the cards that read best in its blank, so the first screenful on the phone is the four best answers.',
    '- **Prompts.** The black deck leads with the great prompts and keeps the filler for the back; the czar bot picks the best-rated of its three.',
