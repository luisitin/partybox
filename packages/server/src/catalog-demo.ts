...
const DEMOS: readonly Demo[] = [
  ...
  ['blind-auction', 'Blind Auction', '🔨', 'Bid on mystery lots. Treasure or trap?', [2, 16], 8, ['strategy', 'bluff'], 'anywhere', ['Everyone starts with 100 coins. A mystery lot appears with a hint of what is inside.', 'Bid in secret. The highest bid wins the lot and pays for it.', 'The lot flips: treasure, trap, heist or swap. Most coins at the end wins.']],
