  ...
  return (
    <Stage>
      ...
      <div className={`${styles.split} ${empty ? styles.splitEmpty : ''}`}>
        <div className={`${styles.join} ${full || locked ? styles.full : ''} ${locked ? styles.locked : ''}`}>
          <BigText
            level="h2"
          ...
          {/* I-055 B: the seal slides across the code as the room locks (over the QR, absolute). */}
          <span className={`${styles.seal} ${locked ? styles.sealOn : styles.sealOff}`} aria-hidden />
