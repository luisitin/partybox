...
/** I-051: the wordmark reacts to the room's big moments: a bump on results. */
        ...
        <div className={styles.brandBlock}>
          {onHome ? (
            ...
            >
              ...
              <span key={brandKey} className={`${styles.brand} ${brandBump ? styles.brandBump : ''}`} aria-live="polite">
                {brandText}
              </span>
            </button>
          ) : (
            <span key={brandKey} className={`${styles.brand} ${brandBump ? styles.brandBump : ''}`}>
              {t.appName}
            </span>
          )}
          {room ? (
