...
import { createMusicEngine, planFor, phoneMusicOn, subscribePhoneMusic, phoneMusicLevel, PHONE_MUSIC_GAIN } from '../music';
...
export function ControllerApp(): JSX.Element {
  ...
  const musicLevel = useSyncExternalStore(subscribePhoneMusic, phoneMusicLevel, () => 'normal' as const);
  ...
  }, [music, musicOn, musicLevel, state.room, state.view]);
