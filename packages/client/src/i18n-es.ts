...
export const es: Texts = {
  ...
  results: {
    ...
    placeBot: 'Te ganó un robot. Piénsalo.',
    placeLast: 'Último. Alguien tenía que serlo.',
    placeRunnerUp: (gap) => `Casi: a ${gap} ${gap === 1 ? 'punto' : 'puntos'} del primero.`,
    placeMiddle: (rank) => `${rank}.º: en pleno pelotón.`,
