...
export const es: Texts = {
  ...
  results: {
    ...
    winners: (names) => `¡${names} comparten el primer puesto!`,
    pair: (a, b) => `${a} y ${b}`,
    tieAmong: (names, others) =>
      `¡${names} y ${others} ${others === 1 ? 'persona más comparten' : 'personas más comparten'} el primer puesto!`,
    tieWithBots: (names, bots) =>
      `¡${names} y ${bots === 1 ? 'el bot comparten' : 'los bots comparten'} el primer puesto!`,
    botTie: 'Los bots comparten el primer puesto: ¿no hay nadie en casa?',
    tie: '¡Todos comparten el primer puesto!',
    over: 'Fin del juego',
    show: '¡Y eso fue todo!',
    ...
    youWin: '¡Ganaste! 🏆',
    youTie: (with_) => `¡Compartes el primer puesto con ${with_}! 🏆`,
    yourPlace: (rank, score) => `Quedaste ${rank}.º · ${score} pts`,
    yourPlaceTied: (rank, score) => `${rank}.º empatado · ${score} pts`,
    andOthers: (name, others) => `${name} y ${others} ${others === 1 ? 'persona más' : 'personas más'}`,
