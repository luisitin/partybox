...
export interface GameClientModule {
  ...
  /**
   * Player ids the TV strip should ring as "on" for this view (I-004): the phones the room is
   * waiting on, the seat reading a card — whoever the room should look at. Default: nobody.
   */
