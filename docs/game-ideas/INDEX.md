...
| ----------------------------- | ------------- | ------ | ------- | ------------------------------------------------------------- | ---------- | ------- | ----------- | ------------ | ----------- | ---------- |
| [001](001-bingo.html)         | Bingo         | idea   | 1–16    | ≈10 min (3 line rounds)                                       | S          | welcome | tap         | free-for-all | luck/speed  | cozy/silly |
| [002](002-broken-pencil.html) | Broken Pencil | idea   | 3–8     | ≈18 min at 8 players (6 min play + 12 min show); ≈10 min at 5 | L          | no      | draw/text   | co-op        | drawing/wit | silly/cozy |
