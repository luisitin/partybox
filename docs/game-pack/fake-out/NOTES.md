...
After session-c [4e7487], the final teaser moved into the score kicker so it no longer adds a
whole row above the board. A 1920×1080 fixture preview with four players places the board at
