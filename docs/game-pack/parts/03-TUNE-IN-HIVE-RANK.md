...
*Batch 4 of 7 · read Part 00 first · this part covers games 5 and 6 of the pack.*
...
type TuneState = {
  ...
  turn: {
    n: number; psychic: PlayerId; team: 'sun' | 'moon' | null; catchUp: boolean;
  ...
  coopTotal: number;
  stats: Record<PlayerId, { bulls: number; dials: number; dist: number; zeros: number; psyTurns: number; psyPts: number }>;
...
```json
{
  ...
  "right": "Hot",
  "clues": [
    { "text": "ice cube", "pos": 3 },   { "text": "snowman", "pos": 6 },
    { "text": "fridge", "pos": 14 },    { "text": "autumn breeze", "pos": 30 },
    { "text": "tap water", "pos": 38 }, { "text": "room temperature", "pos": 50 },
    { "text": "bath", "pos": 66 },      { "text": "summer day", "pos": 72 },
    { "text": "coffee", "pos": 80 },    { "text": "sauna", "pos": 86 },
    { "text": "oven", "pos": 92 },      { "text": "lava", "pos": 97 }
  ]
}
```
...
| Presence | `anywhere` |
| Hook | The countdown from fifth place to first, and the one player who ranked the toddler as the *best* person to be stuck in a lift with. |
...
You're not ranking what *you* like. You're predicting what the room likes.
